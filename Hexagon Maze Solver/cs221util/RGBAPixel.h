...
namespace cs221util {
    ...
    public:  // member functions
        ...
        /**
         * Given a HSL value, converts it to RGB and changes the pixel's value to it
         * @param h Value for the Hue of a HSL colour, [0, 360].
         * @param s Value for the Saturation of a HSL colour, [0, 1].
         * @param l Value for the Luminance of a HSL colour, [0, 1].
         */
